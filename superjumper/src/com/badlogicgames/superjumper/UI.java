...
public interface UI {//MUST FIX LEVELBAR & TEXT RESIZE
	...
	public static final float TEXTSCALE = -SCREENWIDTH *0.0008f;
	...
	public static final float SCREENPAUSEX=SCREENWIDTH*1.6f;
	public static final float SCREENPAUSEY=SCREENHEIGHT*1.1f;
}
